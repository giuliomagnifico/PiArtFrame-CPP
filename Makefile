...
DIR_Main = . / DIR_BIN = . / bin
# Variables
for the e - paper display type and sources
EPD = epd7in5V2
OBJ_C_EPD = $ {
	DIR_EPD
}
...
OBJ_C = $(wildcard $ {
		...
		/*.c ${OBJ_C_Examples} ${DIR_Examples}/ImageData2.c ${DIR_Examples}/ImageData.c ${DIR_FONTS}/*.c ${DIR_Main}/*.cpp ${DIR_Main}/*.c)
		...
		CFLAGS += $(MSG) -D $(EPD) -std=c++17  # Use C++17 standard for structured bindings
